...
public class ChatStroke extends FrameLayout {
    public final static int CHAT_TEXT = 1001;
    public final static int CHAT_VOICE = 1002;
    public final static int CHAT_PICTURE = 1003;
    public final static int CHAT_REDBAG = 1004;
    public final static int CHAT_JOIN_ADN_OUT = 1005;
    public final static int DIR_LEFT = 0;
    public final static int DIR_RIGHT = 1;
    public final static int RED_TYPE = 1; //为群红包
